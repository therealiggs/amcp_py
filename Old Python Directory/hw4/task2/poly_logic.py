# Ну я думал щас исправлю всё быстренько, но в процессе
# обнаружился ещё баг про proizv(4x^1 + 0) = '41', у
# меня нет идей как это пофиксить и я в тильте -_-
# I regret my decision, урок получен. К чужому решению
